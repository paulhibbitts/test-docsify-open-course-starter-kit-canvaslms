...
For example, here is a [Docsify Open Course Site hosted within a Canvas course](https://canvas.sfu.ca/courses/44038/files/15884796/download) and here is a [Docsify Open Course Site hosted within a Moodle course](http://paulhibbitts.net/moodle/mod/resource/view.php?id=25). You can, of course, embed single Docsify Open Course site pages hosted on the same system.
