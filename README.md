...
Want to use your own web server instead of GitHub Pages? You can do that by using a [GitHub Action](https://github.com/features/actions) such as [FTP-Deploy-Action](https://github.com/SamKirkland/FTP-Deploy-Action) to deploy and then update your Docsify site to a destination folder on your web server.
